...
function Cards() {
  return (
    <div className='flex flex-wrap gap-8 items-center justify-center pt-16 pb-28'>
  <div className="yellow w-72 h-40 bg-yellow-400 text-white rounded-2xl relative">
  ...
  <div className="blue w-72 h-40 bg-blue-400 text-white rounded-2xl order-1 lg:order-2 relative">
  ...
  <div className="red w-72 h-40 bg-red-500 text-white rounded-2xl order-2 lg:order-3 relative">
  ...
  <div className="green w-72 h-40 bg-green-400 text-white rounded-2xl order-3 lg:order-4 relative">
    <img src={green} className='absolute right-1 top-1 pb-2 h-full' alt="" />
    <div className="text-overlay">
      <h1 className='text-3xl font-semibold pb-3 p-6'>15+</h1>
      <h3 className='text-xl font-medium pl-4'>Programs and Specializations</h3>
    </div>
  </div>
</div>
